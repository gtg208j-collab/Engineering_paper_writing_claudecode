...
Claude Code will automatically load `CLAUDE.md`, which imports `@WORKFLOW.md`. The full workflow is now active.
...
### Step 4 — Say "Phase 1" to Claude

Claude will guide you through Phase 1 → Phase 8. Follow the instructions in each phase.
